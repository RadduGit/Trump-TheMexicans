...
int main() {
	...
	InputManager& input = InputManager::getHandle();
	while (1) {
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::W)) {
			input.Verificare(sf::Keyboard::Key::W);
		}
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::A)) {
			input.Verificare(sf::Keyboard::Key::A);
		}
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::S)) {
			input.Verificare(sf::Keyboard::Key::S);
		}
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::D)) {
			input.Verificare(sf::Keyboard::Key::D);
		}
	}
	return 0;
}